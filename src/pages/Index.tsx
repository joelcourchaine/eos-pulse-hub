...
const Index = () => {
  ...
  const handleRequestAccess = () => {
    window.location.href =
      "mailto:info@dealergrowth.solutions?subject=Request Access to GO Scorecard Platform&body=Hi, I'm interested in getting access to the GO Scorecard Platform for my dealership.%0A%0ADealership Name:%0AContact Name:%0APhone:%0A";
  };
      ...
      {showInstallBanner && (
        <div className="fixed top-0 left-0 right-0 bg-primary text-primary-foreground p-3 flex items-center justify-between z-50 shadow-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={dismissBanner} className="p-1 hover:bg-primary-foreground/20 rounded" aria-label="Dismiss">
              <X className="h-4 w-4" />
            </button>
          </div>
        </div>
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 ${showInstallBanner ? "pt-20" : ""}`}>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-card p-8 rounded-xl border border-border hover:shadow-lg transition-shadow text-center">
            ...
            <p className="text-muted-foreground">Structured 60-minute cadence keeps meetings focused and productive.</p>
          </div>
        </div>
        ...
        <div className="bg-primary text-primary-foreground rounded-2xl p-12 text-center">
          ...
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Join dealership groups using our platform to drive accountability, track performance, and achieve quarterly
            goals.
          </p>
