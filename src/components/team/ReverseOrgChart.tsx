...
const POSITION_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  assistant_service_manager: { bg: "hsl(215 55% 38%)", text: "hsl(0 0% 100%)", border: "hsl(215 55% 48%)" },
  ...
  express_advisor: { bg: "hsl(142 60% 58%)", text: "hsl(215 25% 15%)", border: "hsl(142 60% 48%)" },
  ...
  shuttle_driver: { bg: "hsl(210 12% 58%)", text: "hsl(0 0% 100%)", border: "hsl(210 12% 68%)" },
