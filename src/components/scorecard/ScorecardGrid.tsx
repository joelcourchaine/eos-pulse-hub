            ...
            {weeks.map((week) => {
              ...
              return (
                <TableHead 
                  key={week.label} 
                  className={cn(
                    "text-center min-w-[90px] max-w-[90px] text-xs py-2",
                  ...
                  {weeks.map((week) => {
                    ...
                    return (
                      <TableCell
                        key={week.label}
                        className={cn(
                          "p-1 relative min-w-[90px] max-w-[90px]",
                      ...
                      >
                        <div className="relative flex items-center justify-center gap-0">
                          ...
                          <Input
                            ...
                            className={cn(
                              "text-center border-0 bg-transparent focus-visible:ring-1 h-8 flex-1 min-w-0 max-w-[70px] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none",
